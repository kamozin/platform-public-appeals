...
- [x] `/appeal/new` открывается без авторизации.
- [x] Гость может сохранить черновик.
- [x] Гость может прикрепить файл.
- [x] Гость может отправить обращение на модерацию.
- [x] Чужой guest draft не открывается без token.
- [x] Авторизованный сценарий не сломан.
- [x] CTA на главной ведёт на `/appeal/new`.
