...
- [ ] Опубликованное обращение отдается по slug.
- [ ] Непубличное обращение не отдается как публичная страница.
- [ ] Nuxt отдает 404 для missing slug.
- [ ] SEO DTO применен в head.
- [ ] Postman обновлен.
