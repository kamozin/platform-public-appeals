...
- [x] Email subscription создается идемпотентно.
- [x] Видео отправляется на модерацию.
- [x] Большой файл возвращает стабильную ошибку.
- [x] Неверный тип файла возвращает стабильную ошибку.
- [x] Postman обновлен.

## Postman

- [x] Добавить subscriptions/support-videos endpoints.
