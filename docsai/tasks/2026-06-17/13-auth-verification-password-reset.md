...
- [x] Email-код отправляется и виден в Mailpit локально.
- [x] Неверный код возвращает стабильную ошибку.
- [x] Истекший код возвращает стабильную ошибку.
- [x] Password reset меняет пароль после валидного challenge.
- [x] Postman обновлен.

## Postman

- [x] Добавить verification и password reset endpoints.
