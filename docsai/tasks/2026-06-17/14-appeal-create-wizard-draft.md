...
- [ ] Авторизованный пользователь может создать черновик.
- [ ] Черновик можно обновить.
- [ ] Чужой черновик недоступен.
- [ ] Wizard не теряет данные между шагами.
- [ ] Postman обновлен.

## Postman

- [ ] Добавить draft endpoints.
