...
- [x] Список комментариев отдается API.
- [x] Авторизованный пользователь может отправить комментарий.
- [x] Гость получает 401 при отправке.
- [x] Пустой комментарий дает 422.
- [x] Postman обновлен.

## Postman

- [x] Добавить comments index/store.
- [x] Добавить примеры 401/422.
