...
- [x] API возвращает группы и категории.
- [x] Nuxt страница рендерит категории на сервере.
- [x] Ссылки категорий не ведут на `.html`.
- [x] 0 новых ошибок static analysis.
- [x] Postman обновлен.

## Postman

- [x] Добавить `GET /api/v1/categories`.
